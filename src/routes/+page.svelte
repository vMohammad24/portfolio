<script lang="ts">
  ...
  import { birthday, languages, skills, socials } from "$lib/data/constants";
  ...
  $: customStatus = $lanyardStore?.activities?.find(
  ...
  {#if $lanyardStore}
    <button
      ...
      style="opacity: {showBackToTop
        ? '1'
        : '0'}; pointer-events: {showBackToTop
        ? 'auto'
    ...
    >
        ...
        <div class="relative z-10 flex flex-col items-center gap-8 md:flex-row">
          ...
          >
            ...
            <img
              ...
              src="https://cdn.discordapp.com/avatars/{$lanyardStore
                .discord_user.id}/{$lanyardStore.discord_user
                .avatar}.webp?size=1024"
              alt="Avatar"
              loading="eager"
            />
          ...
          <div class="mx-auto mt-8 max-w-xl md:ml-48 md:mt-12">
            ...
            >
              <div class="flex items-center gap-3">
                <div
                  class="h-3 w-3 animate-pulse rounded-full bg-lavender"
                ></div>
      ...
      >
        ...
        <div class="space-y-4">
          ...
          >
            ...
            developer looking to improve my skills each day.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div class="mt-8 border-t border-surface0/30 pt-4">
          <h3 class="mb-3 text-lg font-medium text-pink/80">
            Currently Learning
          </h3>
          ...
          {#each projects as project, i}
            ...
            >
              ...
              {:else if project.wakatimeName}
                ...
                >
                  <div
                    class="h-3 w-3 animate-pulse rounded-full bg-surface0"
                  ></div>
                  <span class="text-text-muted text-sm"
              ...
              >
                {#each chartData.segments as segment, i}
                  ...
                  <circle
                    ...
                    use:viewport.intersection
                    class:animate-chart-animated={$viewport.get(
                      sections.wakatime,
                    )}
      ...
      >
        <div
          class="text-text-muted flex flex-col items-center gap-4 text-center"
        >
    ...
    <div class="relative z-10 mx-auto max-w-3xl" in:fade={{ duration: 500 }}>
      ...
      >
        <div class="flex items-center gap-6">
          <div
            class="h-24 w-24 animate-pulse rounded-full bg-surface0/50"
          ></div>
          <div class="space-y-2">
        ...
        <div class="space-y-4">
          {#each Array(5) as _, i}
            <div in:fly={{ y: 10, duration: 300, delay: i * 80 }}>
              ...
              <div
                class="mt-1 h-2 w-full animate-pulse rounded-full bg-surface0/50"
              ></div>
            </div>
          {/each}
        </div>
